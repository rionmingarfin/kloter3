		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container-fluid">
					...
					?> 
					<!-- awal -->
					<a href="?halaman=tambah"  class="btn btn-info">tambah orang</a>
					...
					<table class="table table-bordered boxx" id="person">
						 ...
						 <?php
						 $no=1;
						 $sql=mysqli_query($conn,"SELECT * FROM skils join user on skils.id_user=user.id_user")or die(mysqli_error($conn));
						 while ($row=mysqli_fetch_assoc($sql)) {
								...
								<tr>
									...
									<td><?=$row['skl'];?></td>
									<td>
								    	<a href="?halaman=update&id=<?=$row['id']?>"  class="btn btn-info">tambah</a>
									</td>
									</tr>
						 <?php }?>
						 </tbody>
